...
echo ===================
echo KR: LOL Cookie
echo EN: Try to your custom path of LOL direcotry..
echo ===================
if exist "D:\LOL\Riot Games\League of Legends" (
	SET RADS_PATH="D:\LOL\Riot Games\League of Legends"
)
cls
...
if exist "%RADS_PATH%\Game" (
	...
	if exist "League of Legends.exe" (
		@start "" "League of Legends.exe" "spectator kr3.spectator.op.gg:80 CJcNfnxZF5xXV7ZKXHf5t6WHID/N3LGE 6452788919 KR" "-UseRads" "-Locale=!locale!" "-GameBaseDir=.."
		goto :eof
	)
)
